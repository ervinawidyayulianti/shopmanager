<!DOCTYPE html>
<html>
<title>Shop Manager | Admin Login</title>
...
header("location:my_shop_manager.php");
}else{
 print '
...
<form action="standard_user.php">
<button type="submit" class="btn btn-warning">Standard User</button>
</form>
