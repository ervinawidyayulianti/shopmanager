...
$conn->close();
  ...
  ?>
  <form class="form-inline" action="my_shop_manager.php" method="POST">
...
<tr><th>NAME</th><th>TOTAL ITEM SOLD</th><th>PRICE (Tsh/=)</th><th>DATE AND TIME</th><th>SIGNATURE</th><th>DELETE</th>
</tr>
<?php
include 'database_config3.php';
...
echo '</td><td><a class="btn btn-danger" href="delete.php?id='.$row['id'].'">Delete</a>';
   }
